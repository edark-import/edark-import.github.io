...
<style>
/* ==========================================================================
   SUPERIOR RESPONSIVE NAVBAR SYSTEM (PRO-LEVEL FLUID LAYOUT)
   ========================================================================== */
.glass-navbar {
...
@media (max-width: 1380px) {
    ...
    #adminNav .position-relative:has(#navLiveSearchInput) {
        display: none !important;
    }
    #adminNav .nav-btn-text,
    #adminNav #userEmailShort,
    #adminNav #tipoCambioText {
        display: none !important;
    }
    #adminNav .btn,
